...
<?php
    ...
    $getUser = $objOperationAdmin->getUserInfoById($user_id);
    $getUserInfo =mysqli_fetch_array($getUser);
                                ...
                                <script>
                                  ...
                                  <div class="card-body">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="full_name" class="form-control" id="full_name" placeholder="Full Name" value="<?php echo $getUserInfo['full_name'] ?>" required>
                                      </div>

                                      <div class="row">
                                          <div class="form-group col-6">
                                              <label for="phone">Mobile *</label>
                                              <input type="text" name="phone" class="form-control" id="phone" placeholder="Enter mobile" value="<?php echo $getUserInfo['phone'] ?>" required>
                                          </div>

                                          <div class="form-group col-6">
                                              <label for="email">Email </label>
                                              <input type="email" name="email" class="form-control" id="email" value="<?php echo $getUserInfo['email'] ?>" placeholder="Enter email">
                                          </div>
                                      </div>
                                      ...
                                      <div class="row">
                                          <div class="form-group col-6">
                                              ...
                                              <select id="type" class="select10 form-control" name="type" required>
                                                  ...
                                                  <option value="manager" <?php if (isset($getUserInfo['type']) && $getUserInfo['type'] == 'manager') echo 'selected'; ?>>TMS Manager</option>
                                                  <option value="superviser" <?php if (isset($getUserInfo['type']) && $getUserInfo['type'] == 'superviser') echo 'selected'; ?>>Superviser</option>
                                                  <option value="moderator" <?php if (isset($getUserInfo['type']) && $getUserInfo['type'] == 'moderator') echo 'selected'; ?>>Moderator</option>
                                              </select>
                                          </div>
                                          ...
                                          <div class="form-group col-6">
                                              ...
                                              <select id="status" class="select3 form-control" name="status" required>
                                                  <option value="1" <?php if (isset($getUserInfo['status']) && $getUserInfo['status'] == '1') echo 'selected'; ?>>Active</option>
                                                  <option value="0" <?php if (isset($getUserInfo['status']) && $getUserInfo['status'] == '0') echo 'selected'; ?>>Disable</option>
                                              </select>
                                          </div>
                                      </div>
