        ...
        if ($response === FALSE) {
            ...
            if ($response_data['Status'] == '0') {
                ...
                if ($sendresult) {
                     ...
                     $getUpdate=$objOperationAdmin->update_single_report($user_id);
                    if($getUpdate){
                        ...
                        <div class="card card-info">
                            ...
                            <form id="newEventForm" enctype="multipart/form-data" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <label> name *</label>
                                            <input type="text" name="name" class="form-control" required="required" placeholder="name" value="<?php echo $smsinfo['client_name']; ?>">
                                        </div>
                                   ...
                                   <div class="row">
                                       <div class="col-md-6 col-sm-6">
                                           ...
                                           <input class="form-control" name="loading_point" required="required" placeholder="loading_point" value="<?php echo $smsinfo['load_point']; ?>">
                                       </div>

                                       <div class="col-md-6 col-sm-6">
                                           <label>UnLoading Point*</label>
                                           <input class="form-control" name="unloading_point" required="required" placeholder="unloading_point" value="<?php echo $smsinfo['unload_point']; ?>">
                                       </div>
                                 ...
                                 <div class="col-md-6 col-sm-6">
                                  ...
                                  <!-- Date -->
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <input class="form-control" type="date" name="date" required='required' placeholder="date" value="<?php echo $smsinfo['date'];?>">
                                ...
                                <div class="card-footer">
                                    <button type="submit" name="submit" class="btn btn-block bg-gradient-primary btn-lg"> Send</button>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
