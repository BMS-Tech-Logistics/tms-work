...
<?php
    $getVendorList = $objOperationAdmin->getVendorList();
?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php while($userData=mysqli_fetch_array($getVendorList)){ ?>
                                            <tr data-id="<?php echo $userData['id']; ?>">
                                                <td><?php echo $userData['id'] ?></td>
                                                <td class="vendor-name"><?php echo $userData['vendor_name']; ?></td>
                                                <td class="vendor-mobile"><?php echo $userData['vendor_mobile'] ?></td>
                                                <td class="vendor-email" hidden><?php echo $userData['vendor_email'] ?></td>
                                                <td class="vendor-rent-cate"><?php echo $userData['rent_cate'] ?></td>
                                                <td class="vendor-work-area"><?php echo $userData['work_area'] ?></td>
                                                <td class="vendor-vehicle"><?php echo $userData['no_vehicle']; ?></td>
                                                <td class="vendor-trip"><?php echo $userData['no_trip']; ?></td>
                                                <td class="vendor-join"><?php echo $userData['join_date']; ?></td>
                                                <td class="vendor-status"><?php echo $userData['status'] == 1 ? 'Active' : 'Inactive'; ?></td>
                                             
                                                
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="ml-0" href="update-vendor.php?user_id=<?php echo $userData['id'] ?>"><button type="button" class="btn btn-success btn-sm">
